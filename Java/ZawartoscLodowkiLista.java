...
public class ZawartoscLodowkiLista extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        if(text.equals("Wszystko")){
            databaseProdukty.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    ProduktyLista adapter = new ProduktyLista(ZawartoscLodowkiLista.this, produktList);
